...
/// Financial information editing view
class FinancialInfoView extends StatefulWidget {
  const FinancialInfoView({super.key});

  @override
  State<FinancialInfoView> createState() => _FinancialInfoViewState();
}

class _FinancialInfoViewState extends State<FinancialInfoView> {
